...
For both INSERT, UPDATE, and DELETE statements, look at the [better-sqlite *statements* class](https://github.com/JoshuaWise/better-sqlite3/blob/HEAD/docs/api.md#class-statement) under `run()`.
...
This will be useful as we creat endpoints. 
...
I have set the assignment up using Express.js, which simplifies the creation of endpoints and various other tasks by providing a library of functions tailored to these tasks.
There are other similar libraries and frameworks.
This is one way of doing what we are aiming at doing.

Refer to the [Express documentation](https://expressjs.com/en/4x/api.html) as you work through creating the endpoints.
...
``sage":"1 record deleted: ID 2 (200)"}
